					...
					(e.show = function () {
						...
						if (
							...
							if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
								...
								p(this._element)
									.one(g.TRANSITION_END, function () {
										p(n._element).removeClass($).addClass(z).addClass(U),
											(n._element.style[r] = ""),
						...
						if (!this._isTransitioning && p(this._element).hasClass(U)) {
							...
							if ((p(this._element).trigger(t), !t.isDefaultPrevented())) {
								...
								(this._element.style[n] =
									...
									p(this._element).addClass($).removeClass(z).removeClass(U);
									...
									for (var r = 0; r < i; r++) {
										...
										null !== s &&
											(p([].slice.call(document.querySelectorAll(s))).hasClass(
												...
												p(o).addClass(V).attr("aria-expanded", !1));
									}
							...
							if ((c._clearMenus(), !t)) {
								...
								if ((p(e).trigger(i), !i.isDefaultPrevented())) {
									...
									"ontouchstart" in document.documentElement &&
										...
										p(e).toggleClass(Qe).trigger(p.Event(Ye.SHOWN, n));
								}
							}
						}
					}),
						...
						if (
							...
							p(n).trigger(t),
								t.isDefaultPrevented() ||
									(p(this._menu).toggleClass(Qe),
									p(n).toggleClass(Qe).trigger(p.Event(Ye.SHOWN, e)));
						}
					}),
					(e.hide = function () {
						if (
							...
							p(n).trigger(t),
								t.isDefaultPrevented() ||
									(p(this._menu).toggleClass(Qe),
									p(n).toggleClass(Qe).trigger(p.Event(Ye.HIDDEN, e)));
						}
					}),
					(e.dispose = function () {
									...
									if (
										...
										p(r).trigger(l),
											l.isDefaultPrevented() ||
												...
												p(a).removeClass(Qe),
												p(r).removeClass(Qe).trigger(p.Event(Ye.HIDDEN, s)));
									}
								}
							}
					}),
